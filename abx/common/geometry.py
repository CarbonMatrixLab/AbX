...
#   print(f"residx_rigidgroup_base_atom37_idx: {residx_rigidgroup_base_atom37_idx}")
#   print(f"all_atom_positions: {all_atom_positions}")
  base_atom_pos = batched_select(
      all_atom_positions,
      residx_rigidgroup_base_atom37_idx, batch_dims=1)
#   print(f"base_atom_pos:{base_atom_pos}")
